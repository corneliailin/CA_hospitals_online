...
def patient_age_hist(df, rlnI_col):
    ...
    pat_age_hist['pat_age_hist'] = pat_age_hist.pat_min_age + pat_age_hist.pat_age_hist 
...
def patient_cnty_hist(df, rlnI_col):
    ...
    pat_cnty_hist['pat_cnty_hist'] = pat_cnty_hist.pat_cnty_first + pat_cnty_hist.pat_cnty_hist 
